...
from .encoder import TransformerEncoder,FlashformerEncoder,GATEncoder
    ...
    def __init__(self,
        ...
        if self.encoder_type == 'TransformerEncoder':
            ...
            self.encoder = GATEncoder(batch_size=self.batch_size,
                                      ...
                                      is_train=self.is_train,
                                      device=self.device)
        elif self.encoder_type == 'FlashformerEncoder':
            self.encoder = FlashformerEncoder(batch_size=self.batch_size,
                                              max_length=self.max_length,
                                              input_dimension=self.input_dimension,
                                              hidden_dim=self.hidden_dim,
                                              num_heads=self.num_heads,
